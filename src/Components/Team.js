...
export default function Team() {
  ...
  <Card.Body>
    ...
    <Card.Text>
      ...
      smooth creations. Randy's favourite quoute is "When I dare to be powerful
...
<Card className='randy' style={{ width: '25rem' }}>
  ...
  <Card.Body>
    ...
    <Card.Text>
      Tsidison Makitle was born and bread in the city of Durban located in the KZN province.She is one of the co-founders of 
